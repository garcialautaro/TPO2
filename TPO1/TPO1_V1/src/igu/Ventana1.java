...
public class Ventana1 extends javax.swing.JFrame {
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (!txtDni.getText().isEmpty() && !txtNombre.getText().isEmpty()
            ...
            persona1.cargarPersona(indice, dni, nombre, apellido, direccion, telefono, fnac);
    ...
    private void btnatrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnatrasActionPerformed
        ...
        if (indice >= 1 && indice <= 9) {
            ...
            txtDni.setText(persona1.getDni(indice));
            txtNombre.setText(persona1.getNombre(indice));
            txtApellido.setText(persona1.getApellido(indice));
            txtDireccion.setText(persona1.getDireccion(indice));
            txtTelefono.setText(persona1.getTelefono(indice));
            txtFnac.setText(persona1.getFnac(indice));
        }
